#Strategy optimisation 2. for Week 3 for black-box Function 5 with Sobol Sampling (more suitable than grid sampling for higher dimensionality functions)
...
#Using EI (with xi = 0.01, small exploration parameter) instead of UCB as acqusition function
