"""
Week 3 Black-Box Optimisation (BBO) Capstone Project 
Sequential Bayesian Optimisation using Gaussian Processes (GP) surrogate models

Generating the 3rd query points to be submitted for each of the 8 Black-Box functions
Overall Aim: Global Function Maximisation

Input: wk3_input_data.pkl (containing initial data + 2 submitted queries)
Output: Printed 3rd query coordinates (raw and 6-decimal rounded)
"""
...
def run_all_functions(data: dict):
    ...
    for fn_idx in range(1, 9):
        ...
        print(f"Third raw query point for Function {fn_idx}:", x_next)
        print(f"Third query point for Function {fn_idx} (6 decimals):", np.round(x_next, 6))
        print()
...
if __name__ == "__main__":
    ...
    print("Locating Week 3 input dataset...")
    file_path = "wk3_input_data.pkl"
    ...
    try:
        ...
        # Running the Bayesian Optimization loop for Week 3
