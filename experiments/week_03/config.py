"""
Week 3 BBO - Configurations Module

Hyperparameter configurations, kernel selections, and acquisition strategies for black-box 
functions 1 through 8. Used to generate query predictions in Week 3 of the BBO Capstone Project.
"""

from sklearn.gaussian_process.kernels import RBF, Matern

def get_function_configs():
    """Returning configurations dictionary for each of the 8 Black-Box functions (Week 3)."""
    ...
    return {
        ...
        3: {
            "kernel": RBF(length_scale=[0.1, 0.1, 0.1], length_scale_bounds=(1e-6, 1e8)),
            "alpha": 1e-10,
            "acq_type": "TS",        # Thompson Sampling
            "acq_param": None,
            "sobol_m": 12,
