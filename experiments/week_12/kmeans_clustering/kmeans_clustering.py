...
def run_kmeans_clustering_diagnostics(data, k_range=None, box_margin_fraction=0.1,
                                       ...
                                       plot_output_dir="week_12/diagnostics_results"):
    ...
    with open("week12_kmeans_checkpoint.pkl", "wb") as f:
        pickle.dump(checkpoint, f)
    
    return kmeans_results


def plot_kmeans_cluster_grid(cluster_data_for_plot, output_dir="week_12/diagnostics_results",
