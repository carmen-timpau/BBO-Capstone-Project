""" Next Query Prediction Module [Same as in BBO Week 11 ML Pipeline]
--------------------------------------------------------------------------------------------------------
...
In-depth diagnostics per function are reported, including best full‑domain score, best local‑box score,
