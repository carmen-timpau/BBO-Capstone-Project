...
def main():
    ...
    # Step 3. Executing SVM Classification (Part 2A)
    print("\n" + "=" * 100)
    ...
    # Step 4. Executing MLP Classification (Part 2B)
    print("\n" + "=" * 100)
    ...
    # Step 5. Executing Final Classifier Selection & Comparison Summary (Part 3)
    print("\n" + "=" * 100)
