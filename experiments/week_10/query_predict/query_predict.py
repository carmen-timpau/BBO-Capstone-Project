"""
Upgraded Next Query Prediction Module
---------------------------------------------------------------------------------------
...
def run_next_query_prediction(
    ...
    """Predicting the next query point per function (GP-only, Sobol continuous search)."""
    ...
    for fn_idx in range(1, 9):
        ...
        if acq_type == "random":
            ...
            # Passed a deterministic random_state so Thompson Sampling's next-query pick is reproducible
