...
# WhiteKernel parameters are set based on computed std. dev. of the up-to-date dataset (0.000929)
...
#WhiteKernel to simulate learnable noise rather than setting alpha manually
