#Next Query Prediction for black-box Function 8 Week 4 Submission
...
#Loading the data
X = data["function_8"]["x"]      #shape (43, 8)
Y = data["function_8"]["y"]      #shape (43, )
...
print("Fourth raw query point for Function 8:", x_next)
print("Fourth query point for Function 8 (6 decimals):", np.round(x_next, 6))
