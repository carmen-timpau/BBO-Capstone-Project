...
f6_r2 = r2_score(Y, f6_predictions)
...
plt.title(f'Function 6, Week 5: LOOCV Residuals vs. Predictions (N={n_samples})\n'
          f'RMSE: {f6_rmse:.4f}   | LOOCV R-squared Score: {f6_r2:.4f} |  Breusch-Pagan p-value: {p_value:.5f}', 
