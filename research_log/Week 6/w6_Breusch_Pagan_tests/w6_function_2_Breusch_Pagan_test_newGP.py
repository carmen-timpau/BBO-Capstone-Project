...
# Using newfound GP for Function 2 to remove bias from Week 5's GP tested in 'w6_function_2_Breusch_Pagan_test.py' for Function 2
...
# Running LOOCV Loop across all 15 points using New GP for Function 2 to remove bias from Week 5's GP for Function 2
for j in range(n_samples):
    ...
    kernel = RBF(length_scale=[1.0]*2, length_scale_bounds=(1e-1, 100)) + \
