...
**Kernel Ablation Studies** were performed for all functions in an attempt to identify the optimal acqusition function for each of the 8 Black-Box functions. The code for this can be found in the `w6_kernel_ablation_studies` folder.
