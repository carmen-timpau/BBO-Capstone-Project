...
**Kernel Ablation Studies** were performed for all functions to identify suitable GP surrogate models for the 8 Black-Box functions. This can be found in the `w6_kernel_ablation_studies` folder within this repo.
...
To plot the residuals vs predictions plots, **Leave-One-Out Cross-Validation (LOOCV)** was used.
