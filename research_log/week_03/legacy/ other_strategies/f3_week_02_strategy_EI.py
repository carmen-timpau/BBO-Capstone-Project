...
#+ using EI with xi = 0.01 (small exploration parameter) instead of UCB as the acquisition function
...
kernel = RBF(
    length_scale=[0.1]*3, #ARD, aggresive baseline
    #Changing length_scale from [1.0]*3 to [0.1]*3 (aggresive baseline), because otherwise I got a ConvergenceWarning
