#Strategy optimisation 1. for black-box Function 2
#using Automatic Relevance Determination (ARD) on the RBF kernel with aggresive baseline and wider bounds
#Sobol sampling and UCB acquisition function, with beta = 1.96 (balance between exploitation and exploration)
#Week 2's strategy
