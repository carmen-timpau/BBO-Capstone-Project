# Predicting the first query for black-box Function 3 with Sobol Sampling (more suitable than grid sampling for higher dimensionality functions)
...
# Loading the data
X = data["function_3"]["x"]      #shape (15, 3)
Y = data["function_3"]["y"]      #shape (15, )

# Defining the Gaussian Process model
kernel = RBF(length_scale=[0.1, 0.1, 0.1]) #ARD, aggresive baseline #using Automatic Relevance Determination (ARD) with aggresive baseline and default length_scale_bounds 
...
print("Next raw query point for Function 3:", x_next)
print("Next query point for Function 3 (6 decimals):", np.round(x_next, 6))
