#Strategy Investigation 1. for Week 3 submission of black-box Function 3 with Sobol Sampling (more suitable than grid sampling for higher dimensionality functions)
#using Automatic Relevance Determination (ARD) on the RBF kernel with aggresive baseline and wider bounds
#UCB acqusition function with beta = 1.96 (balance between exploitation and exploration)
