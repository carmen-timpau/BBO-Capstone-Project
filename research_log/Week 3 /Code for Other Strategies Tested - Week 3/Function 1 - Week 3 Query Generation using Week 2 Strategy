#Strategy optimisation 1. for black-box Function 1 Week 3 Subsmission
...
#Sobol sampling
#UCB acquisition function with beta = 4.0 (more exploration encouraged, because the function is mostly close to 0 except in some spiky, sparse regions which must be found)
#Using the same strategy as in Week 2
...
kernel = Matern(length_scale=[0.1, 0.1], nu=1.5, length_scale_bounds = (1e-6, 1e8)) #ARD, aggresive baline and wider bounds
