# Strategy optimisation 3. for black-box Function 1 Week 3 Submission
# Using a Matern kernel (nu=1.5) (because Function 1 is spiky) with applied Automatic Relevance Determination (ARD) with aggresive baseline and wider bounds
# Using Sobol Sampling
# Using Thompson Sampling instead of EI/UCB acquisition functions
...
print("Third query point for Function 1 rounded to 6 decimals:", np.round(x_next, 6))
