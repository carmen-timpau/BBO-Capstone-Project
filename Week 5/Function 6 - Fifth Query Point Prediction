# Fifth Query Prediction for black-box Function 6 Week 5 Submission
# Using Automatic Relevance Determination (ARD) on the RBF kernel with conservative baseline (length_scale=[1.0]*5) and wider length_scale_bounds (1e-6, 1e8)
...
# WhiteKernel parameters are set based on computed std. dev. of the up-to-date dataset (0.467309)
...
#Loading the data
X = data["function_6"]["x"]      #shape (24, 5)
Y = data["function_6"]["y"]      #shape (24, )
...
print("Fifth raw query point for Function 6:", x_next)
print("Fifth query point for Function 6 (6 decimals):", np.round(x_next, 6))
