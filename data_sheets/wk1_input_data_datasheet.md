...
**Dataset File:** [`wk1_input_data.pkl`](https://github.com/carmen-timpau/BBO-Capstone-Project/blob/main/experiments/week_01/wk1_input_data.pkl)
...
This is now a static dataset saved as a .pkl file, which stores all [initial datasets](https://github.com/carmen-timpau/BBO-Capstone-Project/tree/main/data/baseline_data) that have been provided at the beginning of this project by Imperial College London for all 8 unknown objective functions to be maximised within the Black-Box Optimisation Challenge _via_ Bayesian Optimisation. This .pkl file contains the same initial datasets stored individually per function within the [`data/baseline_data`](https://github.com/carmen-timpau/BBO-Capstone-Project/tree/main/data/baseline_data) directory (original files provided by Imperial College London), but saved as a single dictionary (see structure below) for ease of use within the BO ML pipelines developed in this project.
