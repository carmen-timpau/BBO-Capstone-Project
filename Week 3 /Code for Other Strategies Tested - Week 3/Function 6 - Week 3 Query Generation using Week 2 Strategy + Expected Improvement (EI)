...
#Week 2's strategy (that worked better than Week 1's strategy), but using EI with xi = 0.01 (small exploration parameter) instead of UCB as the acquisition function
