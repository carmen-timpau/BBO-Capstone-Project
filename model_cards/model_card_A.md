...
The above is considered an assumption, because it cannot be guaranteed that the week-by-week manual, incremental BO ML model version tuning (function-specific) automatically leads to improvements, but they are intended to, based on previously obtained results, thus being a data-driven, manually tuned pipeline.
